...
<html>
    ...
    <%
		...
		campeao.searchChampion();
		
		String nomeCampeao = campeao.getNomeCampeao();
		String tituloCampeao = campeao.getTituloCampeao();
		String splashCampeao = campeao.getSplashCampeao();
		int idCounter1 = campeao.getId_counter1();
		int idCounter2 = campeao.getId_counter2();
		
		int idRota = campeao.getId_rota();
            ...
            <form class="bg-dark h-75 w-75 p-5" style="margin:auto; margin-top:6%; border-radius: 10px;" id="insereCampeao">
                <div class="centralizar w-50" style="margin-left: auto; margin-right: auto;">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <p>Nome:</p>
                            <input type="text" class="form-control" id="nomeCampeao" name="nomeCampeao" value="<%=nomeCampeao %>">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12">
                            <p style="margin-bottom:0; margin-top:2%;">Titulo:</p>
                            <input type="text" class="form-control" id="tituloCampeao" name="tituloCampeao" value="<%=tituloCampeao %>">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12">
                            <p style="margin-bottom:0; margin-top:2%;">Foto:</p>
                            <input type="text" class="form-control" id="fotoCampeao" name="fotoCampeao" value="<%=splashCampeao%>">
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <input type="hidden" id="idCampeao" name="idCampeao" value="<%=idCampeao %>">
                    <input type="hidden" id="idBuild" name="idBuild" value="<%=idBuild %>">
                    <div class="row">
                        <div class="col-12">
                            <br/>
                            <p>Build:</p>
					...
					function() { 
						$("#btn_enviar").click(
							function() {
								...
								$.post("../model/addCampeaoAlterado.jsp",formData,function(data,status) {
								},'json');
